...
lbl_open = tk.Label(fr_bg1, text="Please choose 2 or more PDFs")
lbl_open.grid(row=0, column=0, sticky="ew", padx=5, pady=5)

btn_open = tk.Button(fr_bg1, text="Browse",command=lambda: open_file(filelist))
...
btn_merge = tk.Button(fr_bg2,        text="Merge PDF",                  state="disabled",command=lambda: merge_pdfs(filelist))
